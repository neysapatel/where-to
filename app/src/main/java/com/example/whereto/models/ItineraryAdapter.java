...
public class ItineraryAdapter extends RecyclerView.Adapter<ItineraryAdapter.ViewHolder> {
    ...
    public ItineraryAdapter(Context context, List<YelpBusiness> businesses) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(YelpBusiness business) {
            ...
            if (business.getImageUrl() != null) {
                int rad = 75;
                Glide.with(context).load(business.getImageUrl()).apply(new RequestOptions().centerCrop().transform(new RoundedCorners(rad))).into(ivAttractionImage);
